...
[
	...
	if test -n "with_cgsi_gsoap_location" ; then
		...
		CGSI_GSOAP_CPP_LIBS="-L$ac_cgsi_gsoap_lib -lcgsi_plugin_cpp_${ac_cgsi_gsoap_version}_cpp"
		CGSI_GSOAP_STATIC_CPP_LIBS="$ac_cgsi_gsoap_lib/libcgsi_plugin_cpp_${ac_cgsi_gsoap_version}_cpp.a"
    else
		CGSI_GSOAP_LOCATION=""
		CGSI_GSOAP_CFLAGS=""
		CGSI_GSOAP_LIBS=""
    ...
    AC_MSG_RESULT([CGSI_GSOAP_CPP_LIBS set to $CGSI_GSOAP_LIBS])
    AC_MSG_RESULT([CGSI_GSOAP_STATIC_CPP_LIBS set to $CGSI_GSOAP_STATIC_LIBS])
