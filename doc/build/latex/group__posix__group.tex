...
\end{Desc}
\begin{Desc}
\item[Returns:]This routine return 0 if the operation was successful, errno if standard error occured or -1 if a internal gfal error occured (see gfal\_\-posix\_\-error()). \par
\begin{itemize}
\item ERRNO list : \par
\begin{itemize}
