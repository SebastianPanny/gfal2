...
\end{Desc}
\begin{Desc}
\item[Returns:]return the file descriptor or -1 if error ( errno is set ( gfal\_\-posix\_\-error\_\-print() ) ) \end{Desc}
...
\end{Desc}
\begin{Desc}
\item[Returns:]file descriptor DIR$\ast$ if success else NULL if error and errno is set ( gfal\_\-posix\_\-error\_\-print() )\end{Desc}
\begin{itemize}
\item ERRNO list : \par
\begin{itemize}
\item usual errors:\begin{itemize}
...
\end{Desc}
\begin{Desc}
\item[Returns:]pointer to struct dirent with file information or NULL if end of list or error ( errno is set ( gfal\_\-posix\_\-error\_\-print() ) ) \end{Desc}
\begin{Desc}
