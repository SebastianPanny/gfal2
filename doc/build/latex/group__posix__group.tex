...
\begin{itemize}
\item usual errors:\begin{itemize}
\item EBADF : incorrecto file descriptor\begin{itemize}
...
int gfal\_\-closedir (DIR $\ast$dir)\{ struct dir\_\-info $\ast$di; int rc;
...
if (strcmp (di-$>$pops-$>$proto\_\-name, \char`\"{}lfc\char`\"{}) == 0) free (di-$>$pops);

free\_\-di (di); return (rc); \} \index{posix_group@{posix\_\-group}!gfal_lseek@{gfal\_\-lseek}}
