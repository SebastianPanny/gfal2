...
\begin{CompactList}\small\item\em free a gfal's context and set to NULL \item\end{CompactList}\item 
...
static int gfal\_\-srmv2\_\-getasync(gfal\_\-handle handle, GList$\ast$ surls, GError$\ast$$\ast$ err)\{ struct srm\_\-context context; struct srm\_\-preparetoget\_\-input preparetoget\_\-input; struct srm\_\-preparetoget\_\-output preparetoget\_\-output; const int size = 2048; char errbuf[size];

srm\_\-context\_\-init(\&context, handle-$>$endpoint\_\-G, errbuf, size, \doxyref{gfal\_\-get\_\-verbose()}{p.}{gfal__common__errverbose_8c_135b3fdd775aa7215e2ab4de1eea495f});
