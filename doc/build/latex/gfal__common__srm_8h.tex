...
int \bf{gfal\_\-get\_\-request\_\-status\-G} (gfal\_\-handle handle, GError $\ast$$\ast$err)
\item 
...
\index{gfal_common_srm.h@{gfal\_\-common\_\-srm.h}!gfal_get_request_statusG@{gfal\_\-get\_\-request\_\-statusG}}
\index{gfal_get_request_statusG@{gfal\_\-get\_\-request\_\-statusG}!gfal_common_srm.h@{gfal\_\-common\_\-srm.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int gfal\_\-get\_\-request\_\-status\-G (gfal\_\-handle {\em handle}, GError $\ast$$\ast$ {\em err})}\label{gfal__common__srm_8h_54237cee8b5d1aa56a4f8619e1c4e392}


get the state of the current async request \begin{Desc}
\item[Returns:]0 : request done with success else report error \end{Desc}
