...
\item 
int($\ast$ \textbf{plugin\_\-parameter} )(plugin\_\-handle handle, const char $\ast$name, char $\ast$value, size\_\-t max\_\-size, int flag\_\-mode, GError $\ast$$\ast$err)\label{struct__gfal__plugin__interface_b2066a5ab243e3d43726b0ab9631a94e}
