...
close the given file handle in the proper plugin \index{gfal_common_plugin.c@{gfal\_\-common\_\-plugin.c}!gfal_plugin_getSURL@{gfal\_\-plugin\_\-getSURL}}
\index{gfal_plugin_getSURL@{gfal\_\-plugin\_\-getSURL}!gfal_common_plugin.c@{gfal\_\-common\_\-plugin.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}char$\ast$$\ast$ gfal\_\-plugin\_\-get\-SURL (gfal\_\-handle {\em handle}, const char $\ast$ {\em path}, GError $\ast$$\ast$ {\em err})}\label{gfal__common__plugin_8c_79e889a6f6f6297772952d69cdfceff7}
...
\index{gfal_common_plugin.c@{gfal\_\-common\_\-plugin.c}!gfal_plugin_getTURLG@{gfal\_\-plugin\_\-getTURLG}}
\index{gfal_plugin_getTURLG@{gfal\_\-plugin\_\-getTURLG}!gfal_common_plugin.c@{gfal\_\-common\_\-plugin.c}}
...
\item[Returns:]pointer to a table of string with all the surls, table end with NULL, or return NULL if error \end{Desc}
\index{gfal_common_plugin.c@{gfal\_\-common\_\-plugin.c}!gfal_plugin_lseekG@{gfal\_\-plugin\_\-lseekG}}
...
open the file specified by path on the proper plugin with the specified flag and mode \index{gfal_common_plugin.c@{gfal\_\-common\_\-plugin.c}!gfal_plugin_putTURLG@{gfal\_\-plugin\_\-putTURLG}}
\index{gfal_plugin_putTURLG@{gfal\_\-plugin\_\-putTURLG}!gfal_common_plugin.c@{gfal\_\-common\_\-plugin.c}}
...
Resolve a surl to a \char`\"{}PUT\char`\"{} turl  if success else -1 if error, \index{gfal_common_plugin.c@{gfal\_\-common\_\-plugin.c}!gfal_plugin_readdirG@{gfal\_\-plugin\_\-readdirG}}
