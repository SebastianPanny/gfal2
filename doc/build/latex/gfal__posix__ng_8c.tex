...
\item 
int \textbf{gfal\_\-set\_\-parameter\_\-string} (const char $\ast$namespace, const char $\ast$key, const char $\ast$value)\label{group__posix__group_g4d93cdd2e28dc1999a6d4bec9b31a871}

\item 
char $\ast$ \textbf{gfal\_\-get\_\-parameter\_\-string} (const char $\ast$namespace, const char $\ast$key)\label{group__posix__group_g936e56956c5c0edcd5e1123cc48a1d27}

\item 
int \textbf{gfal\_\-set\_\-parameter\_\-int} (const char $\ast$module, const char $\ast$name, int value)\label{group__posix__group_g5b629794b469291523731d18e37d47f3}

\item 
int \textbf{gfal\_\-get\_\-parameter\_\-int} (const char $\ast$module, const char $\ast$name)\label{group__posix__group_g6e4c9f15ebca7fb0a2eabff3c1358a7f}

\item 
int \textbf{gfal\_\-set\_\-parameter\_\-boolean} (const char $\ast$namespace, const char $\ast$key, int value)\label{group__posix__group_g7fc063358123fdac94ef6b519f7be89d}

\item 
int \textbf{gfal\_\-get\_\-parameter\_\-boolean} (const char $\ast$namespace, const char $\ast$key)\label{group__posix__group_g2466ac95396b160d91a85f5720e3372d}
