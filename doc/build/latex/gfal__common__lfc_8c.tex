...
Map function for the lfc interface this function provide the generic CATALOG interface for the LFC plugin. lfc\_\-init\-G do : liblfc shared library load, sym resolve, endpoint check, and plugin function map. \index{gfal_common_lfc.c@{gfal\_\-common\_\-lfc.c}!lfc_accessG@{lfc\_\-accessG}}
...
Convert a guid to a plugin url if possible return the link in a plugin's url string or err and NULL if not found \index{gfal_common_lfc.c@{gfal\_\-common\_\-lfc.c}!lfc_statG@{lfc\_\-statG}}
