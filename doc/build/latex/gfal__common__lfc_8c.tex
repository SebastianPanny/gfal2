...
Implementation of the chmod function with the LFC catalog return 0 or the errno if error, or set GError if serious error \index{gfal_common_lfc.c@{gfal\_\-common\_\-lfc.c}!lfc_renameG@{lfc\_\-renameG}}
