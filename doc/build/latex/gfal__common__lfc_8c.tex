...
implementation of the access call with the lfc catalog return 0 or the errno if classical error, report GError$\ast$$\ast$ if serious error \index{gfal_common_lfc.c@{gfal\_\-common\_\-lfc.c}!lfc_chmodG@{lfc\_\-chmodG}}
