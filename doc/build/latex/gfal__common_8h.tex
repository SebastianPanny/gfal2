...
char $\ast$ \textbf{gfal\_\-get\_\-userdn} (char $\ast$errbuf, int errbufsz)\label{gfal__common_8h_6bd6336b0fee1ff32ad6bc5ef3d96068}

\item 
char $\ast$ \textbf{gfal\_\-get\_\-vo} (char $\ast$errbuf, int errbufsz)\label{gfal__common_8h_1d7294ee456d16c8b1bf40f97ffb5081}

\item 
int \textbf{gfal\_\-get\_\-fqan} (char $\ast$$\ast$$\ast$fqan, char $\ast$errbuf, int errbufsz)\label{gfal__common_8h_54b4e29078838583c8022630ef5a2ed3}

\item 
int \textbf{gfal\_\-is\_\-purifydisabled} ()\label{gfal__common_8h_3a35f0e6f616c5108f95cfffd557db77}

\item 
int \textbf{gfal\_\-register\_\-file} (const char $\ast$, const char $\ast$, const char $\ast$, mode\_\-t, GFAL\_\-LONG64, int, char $\ast$, int)\label{gfal__common_8h_db09f20d086253b45c5d2896be95b4a9}
...
\item 
int \textbf{gfal\_\-guidsforpfns} (int, const char $\ast$$\ast$, int, char $\ast$$\ast$$\ast$, int $\ast$$\ast$, char $\ast$, int)\label{gfal__common_8h_72f2d9fb6a55816f243a4c57c5369fe5}

\item 
char $\ast$ \textbf{gfal\_\-guidforpfn} (const char $\ast$, char $\ast$, int)\label{gfal__common_8h_86568afb8c7f9b0d6944de793a3e867a}

\item 
char $\ast$ \textbf{guidfromlfn} (const char $\ast$, char $\ast$, int)\label{gfal__common_8h_47c91fab6a02d32fcc1c6d6a53ba2ce3}

\item 
char $\ast$$\ast$ \textbf{gfal\_\-get\_\-aliases} (const char $\ast$, const char $\ast$, char $\ast$, int)\label{gfal__common_8h_25d4ae6bef6570590efbc8548e7d79e2}
...
\item 
int \textbf{gfal\_\-unregister\_\-pfns} (int, const char $\ast$$\ast$, const char $\ast$$\ast$, int $\ast$$\ast$, char $\ast$, int)\label{gfal__common_8h_70f889fa2436723fb7b3cff20b661f21}

\item 
char $\ast$$\ast$ \textbf{gfal\_\-get\_\-replicas} (const char $\ast$, const char $\ast$, char $\ast$, int)\label{gfal__common_8h_bd0a581309f65e07a5e28d442f07b169}

\item 
char $\ast$ \textbf{gfal\_\-get\_\-hostname} (const char $\ast$, char $\ast$, int)\label{gfal__common_8h_fbe1d2da151f9bd6a0ab1ec1abf0ac81}
