...
IF(PLUGIN_SRM)
	...
	stat_test_all( "SRM_DCACHE" ${srm_valid_dcache_stat})
        checksum_test_simple("SRM_DPM" ${srm_valid_dpm_stat} ADLER32)
        checksum_test_simple("SRM_DCACHE" ${srm_valid_dcache_stat} ADLER32)
...
IF(PLUGIN_GRIDFTP)
	stat_test_all( "GRIDFTP" ${gsiftp_valid_dpm_stat})
        ...
        checksum_test_simple("GRIDFTP" ${gsiftp_valid_dpm_stat} ADLER32)
        checksum_test_simple("GRIDFTP" ${gsiftp_valid_dpm_stat} MD5)
        checksum_test_simple("GRIDFTP" ${gsiftp_valid_dpm_stat} CRC32)
