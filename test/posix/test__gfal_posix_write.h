...
*	auto-generated header file for file test/posix/test__gfal_posix_write.c 
 
*/


void test_mock_write_posix_lfc(const char * url, const char* filename);
void test_mock_write_posix_guid(const char* guid1, const char* filename);
