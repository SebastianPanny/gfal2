...
/** @brief get from the BDII the RLS endpoints 
NOT IMPLEMENTED */
...
/** @brief get from the BDII the CE Accesspoint for a given SE 
 * 
 * */
...
/** @brief  get from the BDII the endpoint for the LFC 
 * 
 **/
...
/** @brief get from the BDII the SE type (disk, srm_v1) 
 * */
