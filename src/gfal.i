...
extern int gfal_deletesurls (gfal_internal req, char *errbuf, int errbufz);
extern int gfal_removedir (gfal_internal req, char *errbuf, int errbufz);
extern int gfal_turlsfromsurls (gfal_internal req, char *errbuf, int errbufz);
extern int gfal_ls (gfal_internal req, char *errbuf, int errbufz);
extern int gfal_ls_end (gfal_internal req, char *errbuf, int errbufz);
extern int gfal_get (gfal_internal req, char *errbuf, int errbufz);
extern int gfal_getstatus (gfal_internal req, char *errbuf, int errbufz);
extern int gfal_prestage (gfal_internal req, char *errbuf, int errbufz);
extern int gfal_prestagestatus (gfal_internal req, char *errbuf, int errbufz);
extern int gfal_pin (gfal_internal req, char *errbuf, int errbufz);
extern int gfal_release (gfal_internal req, char *errbuf, int errbufz);
extern int gfal_set_xfer_done (gfal_internal req, char *errbuf, int errbufz);
extern int gfal_set_xfer_running (gfal_internal req, char *errbuf, int errbufz);
extern int gfal_abortrequest (gfal_internal req, char *errbuf, int errbufz);
extern int gfal_abortfiles (gfal_internal req, char *errbuf, int errbufz);
extern gfal_request gfal_request_new ();
extern int gfal_init (gfal_request req, gfal_internal *gfal, char *errbuf, int errbufz);
...
extern int gfal_set_ids (gfal_internal req, int LEN, const int *LIST, int srm_reqid, const char *srmv2_reqtoken, char *errbuf, int errbufz);
